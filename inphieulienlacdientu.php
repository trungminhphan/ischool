...
?>
	<table width="100%" border="1" cellpadding="10" id="bangdiem" style="margin-top:3px;">
		<tr>
			<th>TỔNG KẾT</th>
...
<div class="page">
<table  width="100%" border="1" cellpadding="20" id="bangdiem" style="margin-top:3px;">
				...
				<ol class="ykienphhs_list">
					...
					if(isset($pll['ykienphhs'])){
						foreach ($pll['ykienphhs'] as $k=>$phhs) {
							echo '<li>'.$phhs['noidung'].'<span class="tag">'.date("d/m/Y h:i", $phhs['ngaycapnhat']->sec).'</span></li>';
						}
					}
					?>
				</ol>				
