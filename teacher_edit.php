...
$gridfs = new GridFS();
$giaovien = new GiaoVien();$csrf = new CSRF_Protect();
...
<h1><a href="profiles.html" class="nav-button transform"><span></span></a>&nbsp;Chỉnh sửa thông tin Giáo viên</h1>
...
<div class="grid">
    <div class="row cells12">
        ...
        <div class="cell colspan2 input-control text">
            <input type="text" name="masogiaovien" id="masogiaovien" value="<?php echo isset($masogiaovien) ? $masogiaovien : ''; ?>"  placeholder="Mã số giáo viên" data-validate-func="required" disabled />
    ...
    <div class="row cells12">
        ...
        <div class="cell colspan2 input-control select">
            <select name="tinhtranghonnhan" id="tinhtranghonnhan">
                <option value="Độc thân" <?php echo  $tinhtranghonnhan == 'Độc thân' ? ' selected' : ''; ?>>Độc thân</option>
                <option value="Có gia đình" <?php echo $tinhtranghonnhan == 'Có gia đình' ? ' selected' : ''; ?>>Có gia đình</option>
            </select>
        </div>
    </div>
    <div class="row cells12">
