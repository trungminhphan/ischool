...
<h1><a href="index.html" class="nav-button transform"><span></span></a>&nbsp;Kết quả giảng dạy theo bảng điểm Cá nhân</h1>
...
Năm học
	...
	<?php if(isset($_GET['submit'])) : ?>
		<a href="inketquagiangday.html?<?php echo $_SERVER['QUERY_STRING']; ?>" class="open_window button"><span class="mif-print"></span> In</a>
	<?php endif; ?>
</form>
<hr />
