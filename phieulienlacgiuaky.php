	...
	<div class="row cells12">
		<div class="cell colspan12 align-center">
			...
			<?php if(isset($_GET['submit'])): ?>
				<a href="inphieulienlacgiuaky.html?<?php echo $_SERVER['QUERY_STRING']; ?>" class="open_window button"><span class="mif-print"></span> In Phiếu liên lạc</a>
				<a href="inphieulienlacgiuaky_all.html?<?php echo $_SERVER['QUERY_STRING']; ?>" class="open_window button"><span class="mif-print"></span> In tất cả học sinh</a>
			<?php endif;?>
		</div>
	</div>
</div>
