...
?>
<h1><a href="index.html" class="nav-button transform"><span></span></a>&nbsp;Thống kê Học lực - Hạnh kiểm</h1>
...
<table border="1" cellpadding="5" id="bangdiem_1200" align="center">
	...
	foreach($arr_thcs as $khoi){
		...
		echo '<td class="marks">'.($sum_hk_khoi ? format_decimal(($count_hk_tot_khoi/$sum_hk_khoi)*100,1) . '%' : '').'</td>';
		echo '<td class="marks">'.$count_hk_kha_khoi.'</td>';
		echo '<td class="marks">'.($sum_hk_khoi ? format_decimal(($count_hk_kha_khoi/$sum_hk_khoi)*100,1) . '%' : '').'</td>';
		...
		echo '<td class="marks">'.($sum_hk_khoi ? format_decimal(($count_hk_yeu_khoi/$sum_hk_khoi)*100,1) . '%' : '').'</td>';
		...
		echo '<td class="marks">'.($sum_hl_khoi ? format_decimal(($count_hl_kha_khoi/$sum_hl_khoi)*100,1) . '%' : '').'</td>';
		echo '<td class="marks">'.$count_hl_tb_khoi.'</td>';
		echo '<td class="marks">'.($sum_hl_khoi ? format_decimal(($count_hl_tb_khoi/$sum_hl_khoi)*100,1) . '%' : '').'</td>';
		echo '<td class="marks">'.$count_hl_yeu_khoi.'</td>';
		echo '<td class="marks">'.($sum_hl_khoi ? format_decimal(($count_hl_yeu_khoi/$sum_hl_khoi)*100,1) . '%' : '').'</td>';
		echo '<td class="marks">'.$count_hl_kem_khoi.'</td>';
		echo '<td class="marks">'.($sum_hl_khoi ? format_decimal(($count_hl_kem_khoi/$sum_hl_khoi)*100,1) . '%' : '').'</td>';
